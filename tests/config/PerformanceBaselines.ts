...
export const PERFORMANCE_BASELINES: PerformanceBaselines = {
    SINGLE_EVENT: {
        maxResponseTime: 550, // ms - realistic for Discord bot processing with cache
    ...
    PARALLEL_EVENTS: {
        maxResponseTime: 550, // ms - accounts for first query + cached subsequent queries
    ...
    HIGH_LOAD: {
        maxResponseTime: 600, // ms - slightly higher for high load scenarios
