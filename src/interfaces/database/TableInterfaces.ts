...
import { Debug_Data, Events_Payload, Games_Settings, Servers_Settings, TimelineEntries_Changes, Users_UserAchievementData } from "../domain";
...
export interface UsersModel {
  ...
  CreatedAt: Date;
  UserAchievementData: Users_UserAchievementData;
...
export function getUsersFieldType(field: UsersModelFieldEnum): BaseEntityFieldType {
  switch (field) {
    ...
    case UsersModelFieldEnum.CreatedAt:
      return BaseEntityFieldType.Date;
    case UsersModelFieldEnum.UserAchievementData:
      return BaseEntityFieldType.Json;
...
export class UsersModel extends BaseEntityClass<UsersModelFieldEnum> implements UsersModel {
  ...
  constructor(data: Partial<UsersModel>) {
    ...
    this.CreatedAt = data.CreatedAt!;
    this.UserAchievementData = data.UserAchievementData!;
...
export interface UsersSaveModel {
  ...
  UserRoleEnum?: enums.UserRoleEnum;
  CreatedAt?: Date;
  UserAchievementDataJSON?: Users_UserAchievementData;
  ExperiencePoints?: number;
}
...
export class UsersSaveModel extends BaseEntityClass<UsersModelFieldEnum> implements UsersSaveModel {
  protected static fieldEnum = UsersModelFieldEnum;
  protected static tableEnum = enums.TableEnum.USERS;
  protected static fieldToPropertyMap: Record<string, string> = { UserAchievementData: "UserAchievementDataJSON" };
  ...
  constructor(data: Partial<UsersSaveModel>) {
    ...
    if (data.CreatedAt !== undefined) this.CreatedAt = data.CreatedAt;
    if (data.UserAchievementDataJSON !== undefined) this.UserAchievementDataJSON = data.UserAchievementDataJSON;
...
export interface UsersAchievementsModel {
  Id: number;
  UserId: string;
  AchievementEnum: enums.AchievementEnum;
  Level: number;
  CreatedAt: Date;
}
